...
# 25-INDICATOR STARTING POOL -> DATA-DRIVEN REDUCED SPACE
# ============================================================
#
...
cat("\nSCRIPT VERSION: HCA_redundancy_reduced_25start — 2026-09-12\n")
...
# ============================================================
# 5. DESCRIPTIVES AND COMPLETE-CASE DIAGNOSTIC
# ============================================================
...
cat("\nStarting-pool complete-case diagnostic:\n")
...
# ============================================================
#
# Redundancy screening is performed on the observed data.
# Median imputation is applied only after the retained variable
# set has been determined, so all 121 primary-party countries
# can enter the distance matrix.
# ============================================================
...
plot(
  ...
  hang = -1,
  main = paste0(
    "Redundancy-reduced direct HCA (25 -> ",
    length(cluster_vars),
    " variables)"
  ),
  xlab = "",
...
analysis_settings <- tibble::tibble(
  ...
  value = c(
    ...
    length(cluster_vars),
    MIL_EXP_SOURCE,
    "variable-wise median imputation after redundancy reduction",
    "none",
    "z-score",
    "Euclidean",
    "Ward.D2",
...
reproducibility_objects <- list(
  ...
  script_version =
    "HCA_redundancy_reduced_25start — 2026-09-12",
